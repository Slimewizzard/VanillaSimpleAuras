...
- **Track Cooldowns**: Display an icon when a specific spell is off cooldown and ready to use.
- **Track Buffs**: Display an icon when a specific buff is active on your character.
- **Visual Alert**: Icons activity appear in a movable frame.
- **Configurable**: Add/Remove spells and buffs via the in-game configuration menu.

## Usage

1.  **Install**: Place the `VanillaSimpleAuras` folder into your `Interface\AddOns` directory.
2.  **Commands**:
